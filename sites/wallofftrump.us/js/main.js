$(document).ready(function(){
	...
	$('#clock').countdown('2016/07/20', function(event) {
	   var $this = $(this).html(event.strftime(''
	    
	     + '<div class="time-p mt-40 text-center" style="width:23%!important;"><span class="days poppins text-uppercase d-black">days</span> <span class="karla fz-60 green-6f">%D</span><span class="year karala fz-14 gray-777"></span></div>  '
	     + '<div class="time-p mt-40 text-center" style="width:23%!important;"><span class="hr poppins text-uppercase d-black">hours</span> <span class="karla fz-60 green-6f">%H</span><span class="year karala fz-14 gray-777"></span></div>  '
	     + '<div class="time-p mt-40 text-center" style="width:23%!important;"><span class="min poppins text-uppercase d-black">mins</span> <span class="karla fz-60 green-6f">%M</span><span class="year karala fz-14 gray-777"></span></div>  '
	     + '<div class="time-p mt-40 text-center" style="width:23%!important;"><span class="sec poppins text-uppercase d-black">secs</span> <span class="karla fz-60 green-6f">%S</span><span class="year karala fz-14 gray-777"></span></div> '));
 	});
 	$(".causes").owlCarousel({
